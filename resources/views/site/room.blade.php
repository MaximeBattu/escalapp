    ...
    <section>
        ...
        @if($hasRoutes && $hasBlocs)
            <section class="section__split">
                <a href="{{route('see_routes', ['name_room_slug'=>Str::slug($room->name_room),'id'=>$room->id_room])}}"><div class="section-split__image image-right"></div></a>
                <div class="section-split__text text-right">Voies</div>
                <a href="{{route('see_blocs', ['name_room_slug'=>Str::slug($room->name_room),'id'=>$room->id_room])}}"><div class="section-split__image image-left"></div></a>
                <div class="section-split__text text-left">Blocs</div>
            </section>
